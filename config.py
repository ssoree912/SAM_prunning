...
def get_train_args():
    ...
    parser.add_argument('--prune-freq', dest='prune_freq', default=8, type=int,
                         help='update frequency')
    parser.add_argument('--prune-rate', dest='prune_rate', default=0.3, type=float,
                         help='pruning rate')
    parser.add_argument('--prune-imp', dest='prune_imp', default='L1', type=str,
                         help='Importance Method : L1, L2, grad, syn')
    parser.add_argument('--mag_type', dest='mag_type', default='weight', type=str,
    ...
    # parser.add_argument('--rho', default = 0, type = int)
...
def base_parser(parser):
    ...
    parser.add_argument('--prune_amplitude', type=float, default=0.5, help='주기적 프루닝의 진폭 (0이면 진동 없음)')

    parser.add_argument('--prune_cycles', type=int, default=3, help='주기적 프루닝의 진동 횟수(주기)')
    parser.add_argument("--mask_finding_cos", type=int, default = 0)
    parser.add_argument("--prune_with_e",type=int,default = 0)
    return parser